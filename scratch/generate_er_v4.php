...
echo "Done — SVG and HTML written with AI Planner below Package.\n";
...
function buildER() {
    ...
    $Lines = [
        ...
        // Rental Service -> Rental Vehicle
        [350, 425, 350, 562, '1'],
        [350, 638, 350, 775, 'N'],
        
        // Package -> AI Planner (The "down side" link)
        [1250, 425, 1250, 562, '1'],
        [1250, 638, 1250, 775, 'N'],
        
        // Bus Booking to Payments
        [800, 425, 800, 587, 'N'],
        [800, 663, 800, 825, 'N'],
        
        // Rental Vehicle to Payments
        [415, 800, 537, 825, '1'],
        [613, 825, 735, 850, '1'],
        
        // AI Planner to Payments
        [1185, 800, 1063, 825, '1'],
        [987, 825, 865, 850, '1'],
    ];
    ...
    // Footer Text
    $s .= "<text x=\"".($W/2)."\" y=\"1150\" font-size=\"22\" font-family=\"Times New Roman\" font-weight=\"bold\" text-anchor=\"middle\">Fig 3.2.2</text>\n";
